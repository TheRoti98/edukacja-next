...
const faqs = [
  {
    ...
    a: 'Jesteśmy na rynku od 2014 roku. Mamy klientów którzy są z nami od ponad 12 lat. Nie pracujemy z każdym — mamy ograniczoną liczbę placówek w obsłudze, żeby żaden klient nie czuł się pominięty.',
  },
  {
    q: 'Prowadzę małe przedszkole lub szkołę — czy to ma dla mnie sens?',
    a: 'Tak. Pakiet Basic jest zaprojektowany właśnie pod mniejsze placówki które chcą przestać przepalać budżet i zacząć mieć system. Nie musisz mieć 200 uczniów żeby sensownie inwestować w reklamy.',
  },
  {
  ...
  {
    q: 'Co konkretnie oznacza "AI w marketingu placówki"?',
    a: 'Praktyczne narzędzia, nie buzzword. Opisy zajęć, posty, automatyczne follow-upy po kontakcie, analiza konkurencji, przygotowanie contentu — rzeczy które Twój zespół robi godzinami, AI robi w minutach. Uczymy jak tego używać, nie zostawiamy z narzędziem bez instrukcji.',
  },
]
